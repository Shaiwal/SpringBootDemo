...
//http://localhost:9000/olx-monitor/bug-fixes/v2 - GET -getBugInfo
//http://localhost:9000/olx-monitor/bug-fixes - GET -getBugFixesInfo
//http://localhost:9000/olx-monitor/bug-fixes/v3?bugs=First-bug,Second-bug - PODT and add content-type application/json - addBug
//http://localhost:9000/olx-monitor/bug-fixes/v2 - DELETE - deleteBug
